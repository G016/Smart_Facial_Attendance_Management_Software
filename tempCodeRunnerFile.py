...
class Student:
    ...
    #     else:
    #         try:
    #             Delete=messagebox.askyesno("","Do You Want To Delete This Student Details?",parent=self.root)
    #             if Delete>0:
    #                 conn=mysql.connector.connect(host="localhost",username="root",password="Gaurav@716",database="face_recognition")
    #                 my_cursor=conn.cursor()
    #                 my_cursor.execute("DELETE student SET Branch=%s, Session=%s, Year=%s, Semester=%s, `Roll No.`=%s, Gender=%s, DOB=%s, Email=%s, `Mobile No.`=%s, `Photo Sample Status`=%s WHERE `Student Name`=%s",(self.var_Branch.get(),
    #                                                                                                                                                                                                                    self.var_Session.get(),
    #                                                                                                                                                                                                                    self.var_Year.get(),
    #                                                                                                                                                                                                                    self.var_Semester.get(),
    #                                                                                                                                                                                                                    self.var_Roll_No.get(),
    ...
    def reset_data(self):
        ...
        self.var_Photo_Sample_Status.set("")
